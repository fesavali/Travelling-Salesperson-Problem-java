...
newfile.open("snow.txt",ios::in); 
  ...
  cout << "myContainer elements:\n\n";
      ...
      while(getline(newfile, myText)){ //read data from file object and put it into string.

      //add data to array list
      myContainer.push_front(myText);
